...
<title>Perfumesx - Alterar categoria</title>
...
<c:import url="menu_include.jsp" /><br>
    <h1>Categorias  <small>  Alterar categoria id° ${categoria.id }</small></h1>
</div>
<div style="margin-top:10px;">
<form:errors path="categoria.nome" style="color:red;" />
...
<fieldset>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" value="${categoria.nome }" id="nome" name="nome">
  </div>
</fieldset>
