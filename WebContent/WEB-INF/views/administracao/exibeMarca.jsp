...
<title>Perfumesx - Alterar marca</title>
...
<c:import url="menu_include.jsp" /><br>
    <h1>Marcas  <small>  Alterar marca id° ${marca.id }</small></h1>
</div>
<div style="margin-top:10px;">
<form:errors path="marca.nome" style="color:red;" />
<form action="alteraMarca" method="post">
...
<fieldset>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" value="${marca.nome }" id="nome" name="nome">
  </div>
</fieldset>
